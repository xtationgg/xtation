...
import { Bell, Pause, Play, RotateCcw, Sparkles, Volume2 } from 'lucide-react';
...
const Proto01MissionComposer: React.FC<UiLabPrototypeRenderProps> = ({ defaultStageSize, assetsPath }) => {
  ...
  return (
    <div className="space-y-4">
      ...
      <Panel title="Mission Composer" subtitle="prototype stage">
        <Stage stageSize={defaultStageSize} referenceImage={`${assetsPath}mission-02.png`}>
...
export default Proto01MissionComposer;
