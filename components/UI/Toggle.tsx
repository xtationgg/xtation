  ...
  return (
    <button
      ...
      className={`ui-pressable inline-flex items-center gap-2 border px-3 py-2 text-[10px] font-semibold uppercase tracking-[0.22em] ${
        checked
          ? 'ui-shape-card border-[var(--ui-accent)] bg-[color-mix(in_srgb,var(--ui-accent)_20%,transparent)] text-[var(--ui-text)] ui-glow'
          : 'ui-shape-card border-[var(--ui-border)] bg-[var(--ui-panel-2)] text-[var(--ui-muted)] hover:text-[var(--ui-text)]'
      }`}
