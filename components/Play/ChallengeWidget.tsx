...
export const ChallengeWidget: React.FC = () => {
  ...
  return (
    <div
      className={`rounded-2xl border border-white/10 bg-gradient-to-b from-[var(--app-panel)] to-[var(--app-bg)] shadow-[0_10px_24px_rgba(0,0,0,0.45)] overflow-hidden transition-all duration-300 ${containerHeight}`}
    >
      {state === 'collapsed' && (
        <button
          type="button"
