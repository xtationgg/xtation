...
export const PlayMenuItem: React.FC<PlayMenuItemProps> = ({
  ...
  return (
    <div
      className={`w-full rounded-xl border border-white/10 bg-gradient-to-b from-[#242427] to-[#1a1a1c] shadow-[0_10px_24px_rgba(0,0,0,0.45)] ${
    ...
    >
      ...
      {subtitle && (
        <div className="px-4 pb-3 text-[9px] uppercase tracking-[0.3em] text-[#726c64]">
          {subtitle}
        </div>
      )}
    </div>
